...
#            result['mandatory'] = True
    ...
    def check_report(self, cr, uid, ids, context=None):
        ...
        if data.get('variables', False) and 'userid' in data['variables']:
            data['variables'].update({'userid': uid})

        _logger.info('\n\n data in check_report: \n'  + str(data) )
        _logger.info("\n\n id in check report :"+str(ids))
        _logger.info("\n\n context in check report :"+str(context.get('service_name', '')))
