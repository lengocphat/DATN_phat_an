...
class audittrail_rule(osv.osv):
    ...
    _columns = {
        ...
        "user_id": fields.many2many('res.users', 'audittrail_rules_users',
                                            'rule_id', 'user_id', 'Users', help="if  User is not added then it will applicable for all users"),
...
#         kw.get('context', {})['is_write_log_from_audittrail'] = True
